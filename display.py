...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.label_11.setGeometry(QtCore.QRect(1300, 550, 151, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_11.setText(_translate("MainWindow", "增强图片数量(每张)："))
    ...
    def setElmentUi(self):
        ...
        self.note.write(tmp_time + " 软件运行成功\n")
        self.note.write(
            tmp_time + " 数据文件来源于: " + os.getcwd() + self.origin_path + " 增强文件保存于: " + os.getcwd() + self.save_path + "\n")
        self.note.close()
    ...
    def task_1(self):
        ...
        if file_path == "":
            ...
            self.note.write(tmp_time + " 未选择文件夹\n")
            self.note.close()
        else:
    ...
    def press_it(self):
        ...
        self.note.write(tmp_time + " 当前源图片为: " + os.getcwd() + "/" + img_path + "\n")
        self.note.close()
    ...
    def press_it_2(self):
        ...
        self.note.write(tmp_time + " 当前显示的增强图片为: " + os.getcwd() + "/" + img_path + "\n")
        self.note.close()
